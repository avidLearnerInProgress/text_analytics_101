...
d1 = """ john fell down harry fellas-well mary was fine down by the stream the sun shone before it went down"""
d2 = """bill fell down jeff fell too belinda was ill down by the river the sun shone until it sunk down"""
d3 = """If you're visiting this page, you're likely here because you're searching for a random sentence. Sometimes a random word just isn't enough, and that is where the random sentence generator comes into play. By inputting the desired number, you can make a list of as many random sentences as you want or need."""
